# Changelog
# 2013.12.25 minor modifications and D.R.Y. improvements (thanks to BioGeek@Reddit)
...
print "Think of it as a hypothetical error correction code, executed at ribosomes."
...
print "This is only one of many possible Arkadian Algorithms.\n"
